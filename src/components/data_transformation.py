...
class DataTransformation():
    def __init__(self, config: DataTransformationConfig, file_path: Path, logger: logging.Logger=logger):
        self.logger = logger
        self.helper = Helper()
        self.config = config
    ...
    def transform_data(self):
        try:
            ...
            self.helper.save_dataframe(data, transformed_file_path, self.logger, index=False)
